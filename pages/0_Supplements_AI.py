...
incident_embeddings = get_embeddings(df['notes'].tolist())

# Question input for general questions
st.subheader("Ask a question about the incidents")
question = st.text_input("Ask question about supplement or health area:")
...
st.subheader("Find similar suppplements")
